...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const transitionFormatted = response.data.transactions.map(
      ...
      setTransactions(transitionFormatted);
      ...
      <Container>
        <CardContainer>
          <Card>
            ...
            <h1 data-testid="balance-income">R$ {balance.income},00</h1>
          </Card>
          <Card>
            <header>
              <p>Saídas</p>
            ...
            <h1 data-testid="balance-outcome">R$ {balance.outcome},00</h1>
          </Card>
          <Card total>
            <header>
              <p>Total</p>
